...
export function ToolCard({ tool }: ToolCardProps) {
  ...
  return (
    <a href={tool.link} target="_blank" rel="noopener noreferrer">
      <Card
        className="group flex transform flex-col p-4 text-primary no-underline shadow-sm transition duration-300 hover:scale-[1.01]"
        gradientColor={
...
function ImagePlaceholder() {
  return (
    <div className="flex h-48 w-full items-center justify-center rounded-sm bg-secondary">
      <Image
